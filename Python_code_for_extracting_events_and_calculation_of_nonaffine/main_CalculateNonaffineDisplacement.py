...
condition_ = '80k_1p5' # string to mark the condition
...
for i_ in range(steps_):
    ...
    # save data
    print('\n-----------------------------------------------------\n')
    np.save('D:/sheared_granular_gouge_different_evironment_condition/python_nonaffine_displacement_data/nonaffine_of_%s_from_%d_to_%d' % \
            (condition_, index_former_[i_], index_later_[i_]), nonaffine_)
